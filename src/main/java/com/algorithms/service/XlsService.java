...
class XlsService {
    ...
    static final int HEADER_WIDTH = 1;
    ...
    void createActiveSheet(String sheetName) {
    ...
    void fillColumn(List<Entry> values, String columnHeader) {
    ...
    void createMultipleRows(int numberOfRows) {
